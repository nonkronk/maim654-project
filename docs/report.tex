...
Model hyperparameters: hidden dimension $H = 64$, number of layers $L = 2$, dropout $p = 0.2$ applied between LSTM layers and within the classifier. The total parameter count is approximately 530K.
